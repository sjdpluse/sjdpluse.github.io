...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-x-hidden px-[5%] sm:px-[5%] lg:px-[10%] py-4 sm:py-0" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto min-h-screen flex items-center">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-6 sm:gap-8 lg:gap-12 xl:gap-20 w-full">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-5 sm:space-y-8 text-center lg:text-left order-2 lg:order-1"
              data-aos="fade-right"
              data-aos-delay="200">
            ...
            <div className="w-full lg:w-1/2 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-1 lg:order-2"
              ...
              <div className="relative w-full h-full opacity-90">
                ...
                <div className={`absolute inset-0 pointer-events-none transition-all duration-700 ${
                  ...
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] lg:w-[400px] lg:h-[400px] bg-gradient-to-br from-indigo-500/10 to-purple-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
